...
In this example we'll load a couple of handy packages. Then import an example dataset. Then we'll have a peek at the data. Next we'll see if sex is realted to disease status using first a Fisher's Exact test and then using logistic regression.
